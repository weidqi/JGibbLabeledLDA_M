...
public class LDADataset {
     ...
     */
    public boolean readDataSet(String filename, boolean unlabeled) throws Exception {
    ...
    /**
     * read a dataset from a text
     *
     * @return true if success and false otherwise
     */
    public boolean readDataSet(String[] content) throws Exception {
        try {
            for (int i = 0; i < content.length; i++) {
                addDoc(content[i], true);
            }
            setM(docs.size());
            // debug output
            System.out.println("Dataset loaded:");
